...
const static lv_i18n_phrase_t es_singulars[] = {
    {"Address", "Dirección"},
    {"Approve", "'Approve' in Spanish is 'Aprobar'"},
    {"Attention", "Atención"},
    {"Cancel", "Cancelar"},
    {"Confirm", "Confirmar"},
    {"Continue", "Continuar"},
    ...
    {"Skip", "Omitir"},
    {"Success", "Éxito"},
    {"Tutorial", "'Tutorial' in Spanish is 'Tutorial'"},
    {"Undo", "Deshacer"},
    {"Update", "Actualizar"},
    ...
    {"about_keystone_discord", "Discord"},
    {"about_keystone_discord_url", "keyst.one/discord"},
    {"about_keystone_telegram", "Telegram in Spanish is Telegrama"},
    {"about_keystone_telegram_url", "t.me/keystonewallet"},
    ...
    {"connect_imtoken_link", "'https://keyst.one/t/3rd/imtoken' should not be translated as it is a website link and not a text that can be translated"},
    {"connect_imtoken_title", "imToken (Móvil)"},
    {"connect_keplr_link", "https://keyst.one/t/3rd/keplr"},
    {"connect_keplr_title", "Keplr (Extensión)"},
    {"connect_mm_link", "https://keyst.one/t/3rd/mm"},
    {"connect_mm_link2", "'https://keyst.one/t/3rd/mmm' should not be translated as it is a URL"},
    {"connect_mm_title", "MetaMask (Extensión)"},
    {"connect_mm_title2", "MetaMask (Móvil)"},
    {"connect_nunchuk_multisig_link", "https://keyst.one/t/3rd/Multisig/nunchuk"},
    {"connect_nunchuk_title", "Nunchuk (Móvil)"},
    {"connect_okx_link", "'https://keyst.one/t/3rd/okx' cannot be translated as it is a web address and does not contain any specific text to translate"},
    {"connect_okx_link2", "https://keyst.one/t/3rd/okxm"},
    ...
    {"connect_safe_link", "'https://keyst.one/t/3rd/safe"},
    {"connect_safe_link2", "'https://keyst.one/t/3rd/safem' should not be translated as it is a URL that does not contain any textual content to be translated"},
    {"connect_safe_title", "Seguro (Web)"},
    {"connect_safe_title2", "Seguro (Móvil)"},
    {"connect_solflare_link", "'https://keyst.one/t/3rd/solflare' is already written in English and does not need to be translated to Spanish"},
    {"connect_solflare_title", "Solflare"},
    {"connect_sparrow_link", "https://keyst.one/t/3rd/sparrow"},
    {"connect_sparrow_multisig_link", "https://keyst.one/t/3rd/Multisig/sparrow"},
    ...
    {"create_multi_wallet_co_sign", "'Co-Sign' en español se traduce como 'respaldar' o 'avalar'"},
    {"create_multi_wallet_co_sign_policy", "Política de Co-Firmantes"},
    {"create_multi_wallet_co_signers", "'Co-Signers' translates to Spanish as 'avalistas'"},
    ...
    {"error_box_duplicated_seed_phrase", "'Duplicate Seed Phrase' translates to 'Frase de Semilla Duplicada' in Spanish"},
    ...
    {"firmware_update_verify_firmware_qr_link", "'KeystoneHQ/keystone3-firmware/docs/verify.md' should be translated to Spanish as 'KeystoneHQ/keystone3-firmware/docs/verificar.md'"},
    ...
    {"import_multi_wallet_info_no_config_file", "No Wallet Files translates to Sin archivos de billetera in Spanish"},
    {"import_multi_wallet_info_title", "Información de la billetera"},
    {"import_multi_wallet_success_title", "Éxito en la importación"},
    {"import_multi_wallet_via_camera", "'Via Camera' in Spanish is 'A través de la cámara'"},
    ...
    {"multi_wallet_no_psbt_file", "No PSBT Files translates to No hay archivos PSBT in Spanish"},
    ...
    {"receive_eth_more_derivation_path_ledger_live", "'Ledger Live' in Spanish is 'Ledger Live'"},
    ...
    {"single_backup_setpin_use_pin", "'Use PIN Code' translated to Spanish is 'Usar código PIN'"},
    ...
    {"single_phrase_reset", "'Reset' in Spanish is 'Restablecer'"},
    ...
    {"tx_details_eth_decoding_qr_link", "'https://keyst.one/t/3rd/ddt' cannot be directly translated to Spanish as it is a website URL. Could you please provide the text you would like to be translated?"},
    {"tx_details_eth_decoding_qr_title", "Decodificando transacciones DeFi"},
    {"tx_details_general_tab_title1", "Visión general"},
